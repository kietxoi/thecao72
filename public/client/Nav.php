        ...
        <div class="container">
            ...
            <div class="navigation nav-left" style="padding-top: 15px">
                <ul>
                    ...
                    <li class="mb-md-3">
                        <a href="<?=BASE_URL('BuyCard');?>" style="color: <?=$CMSNT->site('theme_color');?>">Mua thẻ</a>
                    </li>
                    <?php }?>
                    <?php if($CMSNT->site('status_napdt') == 'ON') { ?>
                    <li class="mb-md-3">
                        <a href="<?=BASE_URL('Topup');?>" style="color: <?=$CMSNT->site('theme_color');?>">Nạp điện
                            thoại</a>
                    </li>
                    <?php }?>
                    <li class="mb-md-3">
                        <a href="<?=BASE_URL('History/Card');?>" style="color: <?=$CMSNT->site('theme_color');?>">Lịch
                            sử đổi thẻ</a>
                    </li>
                    <li class="mb-md-3">
                        <a href="<?=BASE_URL('Ket-noi-api');?>" style="color: <?=$CMSNT->site('theme_color');?>">Kết nối
                            API</a>
                    </li>
                    <li class="mb-md-3">
                        <a href="<?=BASE_URL('Blogs');?>" style="color: <?=$CMSNT->site('theme_color');?>">Tin tức</a>
                    </li>
                </ul>
            </div>

            <?php if(isset($_SESSION['username'])) { ?>
            <span class="pull-right loginBox" style="color: <?=$CMSNT->site('theme_color');?>; padding-top: 15px">
                <span class="navi-wrapper">
                    <div class="navigation">
                        <ul>
                            ...
                            <li>
                                <a href="#" style="color: <?=$CMSNT->site('theme_color');?>"><i class="fa fa-user"
                                        aria-hidden="true"></i>
                                    <?=$getUser['username'];?></a>
                                <ul>
                                    <?php if($getUser['level'] == 'admin') { ?>
